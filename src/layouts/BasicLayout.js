...
class BasicLayout extends React.PureComponent {
  constructor(props) {
    ...
    this.props.menuDataInfo.forEach(getRedirect);
  }
  ...
  getChildContext() {
    ...
    return {
      location,
      breadcrumbNameMap: getBreadcrumbNameMap(this.props.menuDataInfo, routerData),
    };
  }
    ...
    const layout = (
      <Layout>
        <SiderMenu
          ...
          menuData={this.props.menuDataInfo}
          collapsed={collapsed}
          location={location}
          isMobile={mb}
        ...
        <Layout>
          ...
          <Footer style={{ padding: 0 }}>
            <GlobalFooter
              ...
              copyright={
                <Fragment>
                  Copyright <Icon type="copyright" />传化智联-BOSS运营系统
                </Fragment>
              }
            />
          </Footer>
